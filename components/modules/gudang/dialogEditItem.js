...
const DialogEditItem = ({
  ...
  return (
    <>
      <Dialog open={state} onClose={() => setState(false)} maxWidth='lg' fullWidth>
            ...
            <div className='mt-40'>
              <Grid container spacing={0}>
                <Grid item xs={9} md={6} lg={6}>
                  ...
                  <Grid container spacing={1}>
                    <Grid item xs={3.5}>
                      <Typography variant='h1 font-w-600'>Harga Beli</Typography>
                    </Grid>
                    <Grid item xs={6}>
                      <div className='mb-16'>
                        <TextField
                          ...
                          label='Harga Beli'
                          value={createTableItemValidation.values.harga_beli_satuan}
                          onChange={createTableItemValidation.handleChange}
                          error={
                            createTableItemValidation.touched.harga_beli_satuan &&
                            Boolean(createTableItemValidation.errors.harga_beli_satuan)
                          }
                          helperText={
                            createTableItemValidation.touched.harga_beli_satuan &&
                ...
                <Grid item xs={12} md={6} lg={6}>
                  <Grid container spacing={1}>
                    <Grid item xs={3.5}>
                      <Typography variant='h1 font-w-600'>Harga Jual</Typography>
                    </Grid>
                    <Grid item xs={6}>
                      <div className='mb-16'>
                        <TextField
                          ...
                          label='Harga Jual'
                          value={createTableItemValidation.values.harga_jual_satuan}
                          onChange={createTableItemValidation.handleChange}
                          error={
                            createTableItemValidation.touched.harga_jual_satuan &&
                            Boolean(createTableItemValidation.errors.harga_jual_satuan)
                          }
                          helperText={
                            createTableItemValidation.touched.harga_jual_satuan &&
                  ...
                  <Grid container spacing={1}>
                    <Grid item xs={3.5}>
                      <Typography variant='h1 font-w-600'>Total Pembelian</Typography>
                    </Grid>
                    <Grid item xs={6}>
                      <div className='mb-16'>
                        <TextField
                          ...
                          value={createTableItemValidation.values.total_pembelian}
                          onChange={createTableItemValidation.handleChange}
                          error={
                            createTableItemValidation.touched.total_pembelian &&
                            Boolean(createTableItemValidation.errors.total_pembelian)
                          }
                          helperText={
                            createTableItemValidation.touched.total_pembelian &&
                  ...
                  <Grid container spacing={1}>
                    <Grid item xs={3.5}>
                      <Typography variant='h1 font-w-600'>Expired Date</Typography>
                    </Grid>
                    <Grid item xs={6}>
                      <div className='mb-16'>
